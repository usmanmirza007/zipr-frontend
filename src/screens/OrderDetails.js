      ...
      <ScrollView style={{ zIndex: 111, marginTop: -20, }}>
        <View style={{ backgroundColor: '#fff', borderTopRightRadius: 15, borderTopLeftRadius: 15 }}>
          ...
          <View style={{ marginHorizontal: 25, }}>
            <Text style={{ fontSize: 24, marginTop: 16, color: '#000', fontFamily: style.fontFamily.medium }}>Bicyle</Text>
            <Text style={{ fontSize: 14, marginTop: 7, color: '#000', fontFamily: style.fontFamily.regular }}>Item description - Lorem impsum gug  wacin igat  amarLorem ipsum dolor sit amet, consectetur adipiscing elit. </Text>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 24 }}>
              ...
              <View style={{ flexDirection: 'row', width: 110, justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <Text style={{ fontSize: 24, color: '#000', fontFamily: style.fontFamily.regular }}>1</Text>
              ...
              <Text style={{ fontSize: 24, color: '#000', fontFamily: style.fontFamily.medium }}>R0.00</Text>
            </View>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 30 }}>
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <Text style={{ fontSize: 18, color: '#000', fontFamily: style.fontFamily.regular }}>Vendor Name</Text>
              </View>
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>

                <Text style={{ fontSize: 24, color: '#000', marginRight: 8, fontFamily: style.fontFamily.medium }}>4.2</Text>
                <Image resizeMode='contain' style={{ height: 30, width: 30 }} source={images.rating} />
              </View>

            </View>
            <Text style={{ fontSize: 14, marginTop: 7, color: '#000', fontFamily: style.fontFamily.regular }}>Vendor Bio - Lorem impsum gug  wacin igat  amarLorem ipsum dolor sit amet,. </Text>
