...
const CustomerHome = () => {
  ...
  return (
    <View style={{ height: height }}>
      ...
      <TouchableOpacity style={[{ backgroundColor: '#fff', position: 'absolute', zIndex: 111, bottom: 20, right: 25, width: 50, elevation: 3, height: 50, borderRadius: 50 / 2, alignItems: 'center', justifyContent: 'center' }, commonStyle.shadow]}
